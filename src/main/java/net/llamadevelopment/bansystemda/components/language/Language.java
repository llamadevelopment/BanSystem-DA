package net.llamadevelopment.bansystemda.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        BanSystemDA.getInstance().saveResource("messages.yml");
        Config m = new Config(BanSystemDA.getInstance().getDataFolder() + "/messages.yml");
